  ...
  return {
    ...
    output: {
      ...
      filename: isEnvProduction
        ...
        : isEnvDevelopment && 'resource/js/bundle.js',
      // There are also additional JS chunk files if you use code splitting.
      chunkFilename: isEnvProduction
        ? 'resource/js/[name].[contenthash:8].chunk.js'
        : isEnvDevelopment && 'resource/js/[name].chunk.js',
      assetModuleFilename: 'resource/media/[name].[hash][ext]',
            ...
            },
            {
              ...
              use: [
                ...
                },
                {
                  ...
                  options: {
                    name: 'resource/media/[name].[hash].[ext]',
                  },
                },
              ],
              issuer: {
